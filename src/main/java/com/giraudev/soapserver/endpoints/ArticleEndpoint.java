package com.giraudev.soapserver.endpoints;

import com.giraudev.soap_server.*;
import com.giraudev.soapserver.entity.Article;
import com.giraudev.soapserver.service.ArticleService;
...
public class ArticleEndpoint {
    ...
    private static final String NAMESPACE_URI = "http://giraudev.com/soap-server";
    ...
    public GetArticleByIdResponse getArticle(@RequestPayload GetArticleByIdRequest request) {
        ...
        BeanUtils.copyProperties(articleService.getArticleByArticleId(request.getArticleId()), articleInfo);
